...
const BMS = () => {
  ...
  const handleSubmitAnn = () => {
    ...
    fetch('http://localhost:8000/announce/bms/', {
      method: 'POST',
      headers: {
        'Authorization': `Token cf7fb0130d71c67d5d10ce32fc16a6b6d5b05a7c`
      },
      body: formData1
    })
  ...
  const handleSubmitLec = () => {
    ...
    fetch('http://localhost:8000/lecture/create/bms/', {
      method: 'POST',
      body: formData2
    })
    .then(response => response.json())
